...
export class SubCategoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.subCategoryService
      ...
      .subscribe(
        (res: HttpResponse<ISubCategory[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInSubCategories(): void {
    this.eventSubscriber = this.eventManager.subscribe('subCategoryListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ISubCategory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
