...
public class Department implements Serializable {
    ...
    public Department fdcUsers(Set<FdcUser> fdcUsers) {
        this.fdcUsers = fdcUsers;
        return this;
    }

    public Department addFdcUser(FdcUser fdcUser) {
        this.fdcUsers.add(fdcUser);
        fdcUser.setDepartment(this);
        return this;
    }

    public Department removeFdcUser(FdcUser fdcUser) {
        this.fdcUsers.remove(fdcUser);
        fdcUser.setDepartment(null);
        return this;
    }
